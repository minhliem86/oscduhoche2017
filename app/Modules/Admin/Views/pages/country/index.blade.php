			...
			<div class="box">
	            <div class="box-header">
	              <div class="pull-right">
	              	<a href="{!!route('admin.country.create')!!}" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-plus"></i> Add New</a>
				...
				<div class="box-body">
				  ...
				  <table id="table-post" class="table table-bordered table-striped">
				    ...
				    <tbody>
						...
						<tr>
							<td >{!!$item->id!!}</td>
							<td><b><a href="{!!route('admin.country.edit',$item->id)!!}">{!!$item->name!!}</a></b></td>
							<td><img src="{!!$item->img_avatar!!}" width="100" alt=""></td>
							<td>
							<a href="{!!route('admin.country.edit', array($item->id) )!!}" class="btn btn-info btn-xs"> Edit </a> 
							{!!Form::open(array('route'=>array('admin.country.destroy',$item->id),'method'=>'DELETE', 'class' => 'inline'))!!}
